...
def get_solver(eqn_op, precond_op, rhs, solver_options):
    ...
    # call the solver
    (sol, flag) = sla.gmres(eqn_op, rhs, tol=tol, atol=atol, restart=restart, maxiter=maxiter, M=precond_op, callback=fct)
