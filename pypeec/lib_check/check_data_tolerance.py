...
def _check_factorization_options(factorization_options):
    ...
    datachecker.check_integer("thread_pardiso", pardiso_options["thread_pardiso"], can_be_none=True)
    datachecker.check_integer("thread_mkl",  pardiso_options["thread_mkl"], can_be_none=True)
